        ...
        <div class="max-w-1200 mx-auto px-16 px-md-24">
            <div class="text-center flex-column flex-align-center text-center px-16">
                ...
                <p class="fs-18 lh-30 fw-500 mt-0 mb-64 mx-auto max-w-800">
                    <a class="btn btn-3d yellow shadow-yellow-900 btn-3d-pill text-center" href="https://api.whatsapp.com/send?phone=5521972127201&text=olá%20Quero%20me%20tornar%20uma%20Empresa%20parceira" download>Seja nosso parceiro</a>
                </p>
            </div>
        </div>
    </div>

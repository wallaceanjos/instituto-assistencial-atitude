...
if (!empty($sections)) {
    ...
    foreach ($sections as $section) {
        ...
        if ($section_index == 0) {
            ...
            <!-- CUSTOM SECTION -->
            <section class="flex-column background-surface">
                <div class="w-100-p py-64 min-h-400" style="background: url(https://institutoassistencialatitude.com/wp-content/uploads/2024/09/placeholder.png) fixed no-repeat top center / cover;">
